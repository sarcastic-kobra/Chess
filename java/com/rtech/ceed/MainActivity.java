...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
			...
			for(int i=0;i<8;i++) {
				...
				for(int j=0;j<8;j++) {
					...
					if((i+j)%2==0) {
						...
						DisplayBoardBackground[i][j].setBackgroundResource(R.color.colorBoardWhite);
						
					} else {
						
						DisplayBoardBackground[i][j].setBackgroundResource(R.color.colorBoardBlack);
	...
	private void resetColorAtAllowedPosition (ArrayList<Coordinates> listOfCoordinates) {
		...
		for(int i=0; i<listOfCoordinates.size(); i++) {
			...
			if((listOfCoordinates.get(i).getX() + listOfCoordinates.get(i).getY())%2==0) {
				...
				DisplayBoardBackground[listOfCoordinates.get(i).getX()][listOfCoordinates.get(i).getY()].setBackgroundResource (R.color.colorBoardWhite);
				
			} else {
				
				DisplayBoardBackground[listOfCoordinates.get(i).getX()][listOfCoordinates.get(i).getY()].setBackgroundResource (R.color.colorBoardBlack);
	...
	void setColorAtAllowedPosition(ArrayList<Coordinates> list){
		...
		for(int i=0; i<list.size(); i++) {
			...
			if(Board[list.get(i).getX()][list.get(i).getY()].getPiece() == null) {
				...
				DisplayBoardBackground[list.get(i).getX()][list.get(i).getY()].setBackgroundResource(R.color.colorPieceInDanger);
	...
	private void resetColorAtLastPosition(Coordinates lastPos){
		...
		if((lastPos.getX() + lastPos.getY())%2==0) {
			...
			DisplayBoardBackground[lastPos.getX()][lastPos.getY()].setBackgroundResource (R.color.colorBoardWhite);
			
		} else {
			
			DisplayBoardBackground[lastPos.getX()][lastPos.getY()].setBackgroundResource (R.color.colorBoardBlack);
				...
				if (Board[i][j].getPiece () != null) {
					...
					for (int x=0; x< List.size (); x++) {
						...
						if(Board[List.get(x).getX()][List.get(x).getY()].getPiece() instanceof King) {
							...
							if (Board[List.get(x).getX()][List.get(x).getY()].getPiece().isWhite() != FirstPlayerTurn) {
			...
			for(int j=0;j<8;j++) {
				...
				if(Board[i][j].getPiece() != null) {
					...
					for (int x=0;x<List.size();x++) {
						...
						if(Board[List.get(x).getX()][List.get(x).getY()].getPiece() instanceof Bishop) {
							
							if((List.get(x).getX()+List.get(x).getY())%2==0) {
								
								DisplayBoardBackground[List.get(x).getX()][List.get(x).getY()].setBackgroundResource (R.color.colorBoardWhite);
								
							} else {
								
								DisplayBoardBackground[List.get(x).getX()][List.get(x).getY()].setBackgroundResource (R.color.colorBoardBlack);
								
							}
							
							if(Board[i][j].getPiece().isWhite() != Board[List.get(x).getX()][List.get(x).getY()].getPiece().isWhite()) {
								
								DisplayBoardBackground[List.get(x).getX()][List.get(x).getY()].setBackgroundResource (R.color.colorPieceInDanger);
			...
			for(int j=0;j<8;j++) {
				...
				if(Board[i][j].getPiece() != null) {
					...
					for (int x=0;x<List.size();x++) {
						...
						if(Board[List.get(x).getX()][List.get(x).getY()].getPiece() instanceof Knight) {
			...
			for(int j=0;j<8;j++) {
				...
				if(Board[i][j].getPiece() != null) {
					...
					for (int x=0;x<List.size();x++) {
						...
						if(Board[List.get(x).getX()][List.get(x).getY()].getPiece() instanceof Pawn) {
			...
			for(int j=0;j<8;j++) {
				...
				if(Board[i][j].getPiece() != null) {
					...
					for (int x=0;x<List.size();x++) {
						...
						if(Board[List.get(x).getX()][List.get(x).getY()].getPiece() instanceof Queen) {
			...
			for(int j=0;j<8;j++) {
				...
				if(Board[i][j].getPiece() != null) {
					...
					for (int x=0;x<List.size();x++) {
						...
						if(Board[List.get(x).getX()][List.get(x).getY()].getPiece() instanceof Rook) {
